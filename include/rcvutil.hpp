...
void address_received(const std::error_code& ec, const address_type& version, channel_ptr node, peer_address& sender_addr);
...
void transaction_received(const std::error_code& ec, const transaction_type& block,channel_ptr node, peer_address& sender_addr);
